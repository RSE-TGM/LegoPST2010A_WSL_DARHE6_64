...
*       Description:
*       %created_by:    famgr %
*       %date_created:  Fri Apr 12 16:17:59 1996 %
*
**********************************************************************/
/*
   modulo grafics.h
...
/*
 Dimensionamento di BUFDATI
 La dimensione condiziona il numero totale di campioni 
 visualizzabili con l'utility grafics (4 ore per un
 campionamento al secondo)
 */
#define DIM_BUFDATI (4*60*60)
/*
 tempo intercorrente tra due campioni del buffer dei valori
 (caso graf in memoria)
 */
#define INC_SEC 2
