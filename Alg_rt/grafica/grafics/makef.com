...
$if F$SEARCH("lista_file.dat").nes. "" then delete/nolog lista_file.dat;*
...
$end:
$close infile
$ pu/nolog LEGORT_BIN:fgrafics.exe
$ purge/nolog *.obj
$ exit
$finecomp:
...
$ 'linkexe/exe=LEGORT_BIN:fgrafics grafics.obj,-
               grsfio.obj,-
               LEGOROOT_LIB:libutilx/lib, LEGORT_LIB:libsim/lib,-
	       LEGORT_LIB:libcom/lib,LEGOROOT_LIB:libutil/lib,-
               sys$input/opt
