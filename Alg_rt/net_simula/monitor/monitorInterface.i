! UIMX ascii 2.5 key: 860                                                       

*monitorInterface.class: topLevelShell
*monitorInterface.gbldecl: #include "sim_param.h"\
#include "sim_types.h"\
#include "dispatcher.h"\
#define MAX_PATH_LEN 200
*monitorInterface.ispecdecl:
*monitorInterface.funcdecl: swidget create_monitorInterface()\

*monitorInterface.funcname: create_monitorInterface
*monitorInterface.funcdef: "swidget", "<create_monitorInterface>(%)"
*monitorInterface.icode: char path[MAX_PATH_LEN];\
char sim_name[MAX_PATH_LEN];
*monitorInterface.fcode: strcpy (path,get_pwd());\
...
*monitorInterface.auxdecl:
*monitorInterface.name.source: public
*monitorInterface.static: false
*monitorInterface.name: monitorInterface
*monitorInterface.parent: NO_PARENT
*monitorInterface.parentExpression: UxWidgetToSwidget(UxTopLevel)
*monitorInterface.x: 0
*monitorInterface.y: 0
*monitorInterface.width: 510
*monitorInterface.height: 210
*monitorInterface.title: "MASTER MONIT"
*monitorInterface.allowShellResize: "true"
*monitorInterface.iconName: "MASTER INSTRUCTOR STATION"

*form1.class: form
*form1.static: true
*form1.name: form1
*form1.parent: monitorInterface
