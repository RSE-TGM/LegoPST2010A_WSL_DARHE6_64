...
*sessionName.funcdecl: swidget create_sessionName(char *tit)\

*sessionName.funcname: create_sessionName
*sessionName.funcdef: "swidget", "<create_sessionName>(%)"
*sessionName.argdecl: char *tit;
*sessionName.arglist: tit
*sessionName.arglist.tit: "char", "*%tit%"
...
*form6.initialFocus: "sessionNameSavepb"
...
*sessionNameSavepb.rightPosition: 60
*sessionNameSavepb.leftPosition: 40
