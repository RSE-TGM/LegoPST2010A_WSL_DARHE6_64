...
C
 ...
 1005 FORMAT(2X,I3,1X,'CALL ',A4,'I2(IFUN,VAR,MX1,I1,I2,XYU,DATI,K1,
     &K2,IBLOC1,IBLOC2,'/5X,'&',12X,'IER,CNXYU,TOL)')
      WRITE(IOUT,1004)KEN
   25 CONTINUE
      GO TO 50
C
 ...
 1006 FORMAT(2X,I3,1X,'CALL ',A4,'C1(IFUN,AJAC,MXX,IXYU,XYU,IPD,DATI,
     &RNI,NOBL1,NOBL2)')
      WRITE(IOUT,1004)KEN
   35 CONTINUE
      GO TO 50
