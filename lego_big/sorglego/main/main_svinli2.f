C*********************************************************************
C       Fortran Source:             main_svinli2.f
C       Subsystem:              1
C       Description:
C       %created_by:    lomgr %
C       %date_created:  Tue Aug 21 10:17:17 2001 %
C
C**********************************************************************
...
C
      BLOCK DATA BDD_main_svinli2_f
      CHARACTER*80  RepoID
      COMMON /CM_main_svinli2_f / RepoID
      DATA RepoID/'@(#)1,fsrc,main_svinli2.f,2'/
      END
C**********************************************************************
        PROGRAM MODDATI
C>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
C      WRITE(IOUT,'(A)')'      SUBROUTINE MODDATI(KI,IFO,IOB,DEBL)'
 ...
 666  FORMAT(6X,'SUBROUTINE MODIDAT(KI,IFUN,IBLOC1,IBLOC2,VAR,NX5,
     &I1,I2,XYU,'/5X,'&',19X,'DATI,K1,K2,IER,CNXYU,TOL)')
...
C
C      WRITE(6,1010)
C 1010 FORMAT(//10X,'CREATA LA SUBROUTINE MODIDAT IN MAIN_SVINLI2.FOR')
      STOP ' '
