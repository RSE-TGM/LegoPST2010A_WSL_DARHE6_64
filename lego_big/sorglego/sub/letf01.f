C*********************************************************************
C       Fortran Source:             letf01.f
C       Subsystem:              1
C       Description:
C       %created_by:    lomgr %
C       %date_created:  Tue Aug 21 10:27:11 2001 %
C
C**********************************************************************
...
C
      BLOCK DATA BDD_letf01_f
      CHARACTER*80  RepoID
      COMMON /CM_letf01_f / RepoID
      DATA RepoID/'@(#)1,fsrc,letf01.f,2'/
      END
C**********************************************************************
...
C
C
      DIMENSION NASL(*),ISL(*),NOSL(*),IPUNB(*),NOSCHE(*)
C
      CHARACTER*(*) FIL01(*),LISCHE(*)
C
      CHARACTER*32 LG1ERR
...
C
         DO 701 JJ=1,NSCHE
         J=-JJ
         IF(NOSCHE(JJ).EQ.IDMOD)GO TO 112
  701    CONTINUE
