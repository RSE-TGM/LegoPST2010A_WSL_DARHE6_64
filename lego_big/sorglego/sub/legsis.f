...
C
     ...
     $'KTRE      TEMPO DI CALCOLO (SEC) DEI RESIDUI PER OGNI PASSO DI INTEGRAZIONE',
     $'KTSO      TEMPO DI CALCOLO (SEC) DELLE SOLUZIONI PER OGNI PASSO DI INTEGRAZIONE',
     $'KTJA      TEMPO DI CALCOLO (SEC) DELLO JACOBIANO PER OGNI PASSO DI INTEGRAZIONE' /
C
