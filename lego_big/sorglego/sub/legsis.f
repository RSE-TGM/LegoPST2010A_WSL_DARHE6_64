...
!      4'KTRE  TEMPO DI CALCOLO (SEC) DEI RESIDUI PER OGNI PASSO'//
!      5' DI INTEGRAZIONE',
!      6'KTSO  TEMPO DI CALCOLO (SEC) DELLE SOLUZIONI PER OGNI PASSO'//
!      7' DI INTEGRAZIONE',
!      8'KTJA  TEMPO DI CALCOLO (SEC) DELLO JACOBIANO PER OGNI PASSO'//
!      9' DI INTEGRAZIONE' /
C
...
C
      ...
      DESC(4)='KTRE  TEMPO DI CALCOLO (SEC) DEI RESIDUI PER '//
     $'OGNI PASSO DI INTEGRAZIONE'
      DESC(5)='KTSO  TEMPO DI CALCOLO (SEC) DELLE SOLUZIONI PER '//
     $'OGNI PASSO DI INTEGRAZIONE'
      DESC(6)='KTJA  TEMPO DI CALCOLO (SEC) DELLO JACOBIANO PER '//
     $'OGNI PASSO DI INTEGRAZIONE'
