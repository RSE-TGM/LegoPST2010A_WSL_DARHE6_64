...
*       Description:
*       %created_by:    carlo %
*       %date_created:  Tue Nov 19 18:20:15 1996 %
*
**********************************************************************/
#ifndef lint
static char *_csrc = "@(#) %filespec: VarEdit.c-3 %  (%full_filespec: VarEdit.c-3:csrc:2 %)";
#endif
	...
	char 	*argv[];
{
	...
	setlocale(LC_ALL, "");
  	...
  	UxTopLevel = XtAppInitialize(&UxAppContext, "VarEdit",
