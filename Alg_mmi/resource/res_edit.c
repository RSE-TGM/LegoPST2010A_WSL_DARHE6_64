...
*       Description:
*       %created_by:    carlo %
*       %date_created:  Tue Nov 19 17:51:15 1996 %
*
**********************************************************************/
#ifndef lint
static char *_csrc = "@(#) %filespec: res_edit.c-2 %  (%full_filespec: res_edit.c-2:csrc:2 %)";
#endif
	...
	char 	*argv[];
{
	...
	setlocale(LC_ALL, "");
  	...
  	UxTopLevel = XtAppInitialize(&UxAppContext, "res_edit",
