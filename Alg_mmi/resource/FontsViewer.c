...

{
	...
	set_something_val (FontSample1, XmNset, (XtArgVal) False);
	set_something_val (FontSample2, XmNset, (XtArgVal) False);
	set_something_val (FontSample3, XmNset, (XtArgVal) False);
	set_something_val (FontSample4, XmNset, (XtArgVal) False);
	
	get_something (FontSample5, XmNfontList, (void*) &Fontl);
	set_something_val (LabelFont , XmNfontList, (XtArgVal) Fontl);
...

{
	...
	set_something_val (FontSample2, XmNset, (XtArgVal) False);
	set_something_val (FontSample3, XmNset, (XtArgVal) False);
	set_something_val (FontSample5, XmNset, (XtArgVal) False);
...

{
	...
	set_something_val (ListaRC[0], XmNsensitive, (XtArgVal) True);
	set_something_val (ListaRC[2], XmNsensitive, (XtArgVal) True);
...

{
	...
	if ( (FontInfo = XLoadQueryFont (UxDisplay,StrFont) ) == NULL)
		...
		set_something_val (LabelFont , XmNfontList, (XtArgVal) FontList);
		XmTextFieldSetString (ListaRC[2], StrFont);
		switch (SettaFont)
		{
		case 1:
			set_something_val (FontSample1,XmNfontList,(XtArgVal) FontList);
			strcpy (VettoreFont[0],StrFont);
		break;
		case 2:
			set_something_val (FontSample2,XmNfontList,(XtArgVal) FontList);
			strcpy (VettoreFont[1],StrFont);
		break;
		case 3:
			set_something_val (FontSample3,XmNfontList,(XtArgVal) FontList);
			strcpy (VettoreFont[2],StrFont);
		break;
		case 4:
			set_something_val (FontSample4,XmNfontList,(XtArgVal) FontList);
			strcpy (VettoreFont[3],StrFont);
		break;
		case 5:
			set_something_val (FontSample5,XmNfontList,(XtArgVal) FontList);
