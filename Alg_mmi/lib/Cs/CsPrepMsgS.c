...
*       Description:
*       %created_by:    famgr %
*       %date_created:  Tue Feb 18 12:48:52 1997 %
*
**********************************************************************/
#ifndef lint
static char *_csrc = "@(#) %filespec: CsPrepMsgS.c-2 %  (%full_filespec: CsPrepMsgS.c-2:csrc:1 %)";
#endif
/*
   modulo CsPrepMsg.c
   tipo 
...
*/
int CsPrepMsgS(char *nome_pagina, int coda, int t_agg, int indice, int tipo,
...
/*printf("CsPrepMsgS:nome_pagina=%s -- coda=%d\n",nome_pagina,coda);*/
/* Parte comune */
   if(prog_punti==0)
     {
     conta_punti=0;
