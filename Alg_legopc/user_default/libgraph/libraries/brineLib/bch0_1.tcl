...
set mymodId [$c create image $x $y -image bch0_1$GIForient]
...
set port0.$mymodId { WTUB PITU PIFO ZUPS ____ HTUB ____ ____ }
...
set port1.$mymodId { WTUB PUTU PUFO ZDWN ____ HTUB ____ HINV }
