...
set mymodId [$c create image $x $y -image bch0_0$GIForient]
...
set port0.$mymodId { WTUB PITU PIFO FNAC HTUB ____ ____ ZUPS ____ ____ }
...
set port1.$mymodId { WTUB PUTU PUFO FNAC HTUB FINV HINV ZDWN ____ ____ }
