...
set mymodId [$c create image $x $y -image seap_1$GIForient]
...
set port0.$mymodId { WI_1 PSER TI_1 TSER XXX1 XXX2 XXX3 XXX4 }
...
set port1.$mymodId { WU_1 PSER TSER TU_1 XXX1 XXX2 XXX3 XXX4 }
