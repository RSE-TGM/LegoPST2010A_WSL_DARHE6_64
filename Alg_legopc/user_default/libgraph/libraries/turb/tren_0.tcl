...
set mymodId [$c create image $x $y -image tren_0$GIForient]
...
switch $GIForient {
n {set myportId [$c create image [expr $x + 8.0] [expr $y + 26.0] -image hydr_s -anchor n]}
e {set myportId [$c create image [expr $x + -26.0] [expr $y + 8.0] -image hydr_w -anchor e]}
s {set myportId [$c create image [expr $x + -8.0] [expr $y + -26.0] -image hydr_n -anchor s]}
w {set myportId [$c create image [expr $x + 26.0] [expr $y + -8.0] -image hydr_e -anchor w]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
set port1.$mymodId { WUTZ PUTZ ____ ____ ____ HUTZ ____ ____ }
