...
set mymodId [$c create image $x $y -image brtt_3$GIForient]
...
set port0.$mymodId { WAIR PPPP TAIR ____ ____ ____ ____ ____ }
...
set port1.$mymodId { WCO1 PPPP TCO1 ____ ____ ____ ____ ____ }

switch $GIForient {
n {set myportId [$c create image [expr $x + 0.0] [expr $y + 26.0] -image flue_n -anchor n]}
e {set myportId [$c create image [expr $x + -26.0] [expr $y + 0.0] -image flue_e -anchor e]}
s {set myportId [$c create image [expr $x + 0.0] [expr $y + -26.0] -image flue_s -anchor s]}
w {set myportId [$c create image [expr $x + 26.0] [expr $y + 0.0] -image flue_w -anchor w]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
set port3.$mymodId { WBYP PPPP TBYP ____ ____ ____ ____ ____ }
...
set port2.$mymodId { WFUM PPPP TFUM ____ XCOM XH2O XXCH ZMN2 }
