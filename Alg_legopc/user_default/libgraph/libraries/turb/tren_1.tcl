...
set mymodId [$c create image $x $y -image tren_1$GIForient]
...
switch $GIForient {
n {set myportId [$c create image [expr $x + -26.0] [expr $y + 0.0] -image hydr_w -anchor e]}
e {set myportId [$c create image [expr $x + 0.0] [expr $y + -26.0] -image hydr_n -anchor s]}
s {set myportId [$c create image [expr $x + 26.0] [expr $y + 0.0] -image hydr_e -anchor w]}
w {set myportId [$c create image [expr $x + 0.0] [expr $y + 26.0] -image hydr_s -anchor n]}
}
...
set port0.$mymodId { WUTZ PUTZ ____ ____ ____ HUTZ ____ ____ }
...
set port2.$mymodId { WSPZ PSPZ ____ ____ ____ HSPZ ____ ____ }
...
set port1.$mymodId { WITZ PITZ ____ ____ ____ HITZ ____ ____ }
