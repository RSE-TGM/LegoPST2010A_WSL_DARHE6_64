...
set mymodId [$c create image $x $y -image damp_0$GIForient]
...
set port0.$mymodId { WFSR PFSM TFSI TFSU ____ ____ ____ ____ }
...
set port1.$mymodId { WFSR PFSV TFSU TFSI ____ ____ ____ ____ }

switch $GIForient {
n {set myportId [$c create image [expr $x + 0.0] [expr $y + -34.0] -image comm_s -anchor s]}
e {set myportId [$c create image [expr $x + 34.0] [expr $y + 0.0] -image comm_w -anchor w]}
s {set myportId [$c create image [expr $x + 0.0] [expr $y + 34.0] -image comm_n -anchor n]}
w {set myportId [$c create image [expr $x + -34.0] [expr $y + 0.0] -image comm_e -anchor e]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
