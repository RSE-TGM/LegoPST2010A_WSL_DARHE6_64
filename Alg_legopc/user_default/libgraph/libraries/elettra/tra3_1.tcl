...
set mymodId [$c create image $x $y -image tra3_1$GIForient]
...
set port3.$mymodId { VFR1 VFX1 IR1_ IX1_ }
...
set port1.$mymodId { VFR2 VFX2 IR2_ IX2_ }
...
set port4.$mymodId { VFR3 VFX3 IR3_ IX3_ }
