...
set mymodId [$c create image $x $y -image traf_0$GIForient]
...
set port0.$mymodId { UR1T UX1T IRT1 IXT1 }
...
set port1.$mymodId { SIN1 }

switch $GIForient {
n {set myportId [$c create image [expr $x + 26.0] [expr $y + 12.0] -image comm_w -anchor w]}
e {set myportId [$c create image [expr $x + -12.0] [expr $y + 26.0] -image comm_n -anchor n]}
s {set myportId [$c create image [expr $x + -26.0] [expr $y + -12.0] -image comm_e -anchor e]}
w {set myportId [$c create image [expr $x + 12.0] [expr $y + -26.0] -image comm_s -anchor s]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
set port3.$mymodId { SIN2 }

switch $GIForient {
n {set myportId [$c create image [expr $x + 26.0] [expr $y + 0.0] -image elek_e -anchor w]}
e {set myportId [$c create image [expr $x + 0.0] [expr $y + 26.0] -image elek_s -anchor n]}
s {set myportId [$c create image [expr $x + -26.0] [expr $y + 0.0] -image elek_w -anchor e]}
w {set myportId [$c create image [expr $x + 0.0] [expr $y + -26.0] -image elek_n -anchor s]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
set port2.$mymodId { UR2T UX2T IRT2 IXT2 }
