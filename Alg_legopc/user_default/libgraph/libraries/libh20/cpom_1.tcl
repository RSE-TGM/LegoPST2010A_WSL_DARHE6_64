...
set mymodId [$c create image $x $y -image cpom_1$GIForient]
...
set port0.$mymodId { WPOM PIPM ____ ____ ____ HIPM ____ HUPM }
...
set port1.$mymodId { WPOM PUPM ____ ____ ____ HUPM ____ ____ }
