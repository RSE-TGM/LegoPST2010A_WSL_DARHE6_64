...
set mymodId [$c create image $x $y -image mixn_0$GIForient]
...
switch $GIForient {
n {set myportId [$c create image [expr $x + -18.0] [expr $y + 12.0] -image hydr_e -anchor e]}
e {set myportId [$c create image [expr $x + -12.0] [expr $y + -18.0] -image hydr_s -anchor s]}
s {set myportId [$c create image [expr $x + 18.0] [expr $y + -12.0] -image hydr_w -anchor w]}
w {set myportId [$c create image [expr $x + 12.0] [expr $y + 18.0] -image hydr_n -anchor n]}
}
...
set port2.$mymodId { WE_2 XXXX ____ ____ ____ HE_2 ____ HMIX }
...
set port0.$mymodId { WE_1 XXXX ____ ____ ____ HE_1 ____ HMIX }
