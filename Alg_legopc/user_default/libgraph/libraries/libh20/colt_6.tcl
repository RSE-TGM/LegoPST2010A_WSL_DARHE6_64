...
set mymodId [$c create image $x $y -image colt_6$GIForient]
...
switch $GIForient {
n {set myportId [$c create image [expr $x + 0.0] [expr $y + -22.0] -image dump_s -anchor s]}
e {set myportId [$c create image [expr $x + 22.0] [expr $y + 0.0] -image dump_w -anchor w]}
s {set myportId [$c create image [expr $x + 0.0] [expr $y + 22.0] -image dump_n -anchor n]}
w {set myportId [$c create image [expr $x + -22.0] [expr $y + 0.0] -image dump_e -anchor e]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
set port2.$mymodId { ____ TEST GEST ____ ____ ____ ____ ____ ____ ____ }
