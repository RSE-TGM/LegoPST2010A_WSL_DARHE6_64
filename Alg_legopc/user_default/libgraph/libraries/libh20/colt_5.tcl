...
set mymodId [$c create image $x $y -image colt_5$GIForient]
...
switch $GIForient {
n {set myportId [$c create image [expr $x + 18.0] [expr $y + -20.0] -image hydr_e -anchor w]}
e {set myportId [$c create image [expr $x + 20.0] [expr $y + 18.0] -image hydr_s -anchor n]}
s {set myportId [$c create image [expr $x + -18.0] [expr $y + 20.0] -image hydr_w -anchor e]}
w {set myportId [$c create image [expr $x + -20.0] [expr $y + -18.0] -image hydr_n -anchor s]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
switch $GIForient {
n {set myportId [$c create image [expr $x + 22.0] [expr $y + 0.0] -image hydr_e -anchor w]}
e {set myportId [$c create image [expr $x + 0.0] [expr $y + 22.0] -image hydr_s -anchor n]}
s {set myportId [$c create image [expr $x + -22.0] [expr $y + 0.0] -image hydr_w -anchor e]}
w {set myportId [$c create image [expr $x + 0.0] [expr $y + -22.0] -image hydr_n -anchor s]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
