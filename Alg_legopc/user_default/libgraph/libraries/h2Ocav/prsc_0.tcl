...
set mymodId [$c create image $x $y -image prsc_0$GIForient]
...
set port0.$mymodId { WREF ____ ____ ____ ____ HIRE ____ ____ }
...
set port1.$mymodId { WREF ____ ____ ____ ____ HURE ____ ____ }

switch $GIForient {
n {set myportId [$c create image [expr $x + 18.0] [expr $y + 0.0] -image dump_w -anchor w]}
e {set myportId [$c create image [expr $x + 0.0] [expr $y + 18.0] -image dump_n -anchor n]}
s {set myportId [$c create image [expr $x + -18.0] [expr $y + 0.0] -image dump_e -anchor e]}
w {set myportId [$c create image [expr $x + 0.0] [expr $y + -18.0] -image dump_s -anchor s]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
set port5.$mymodId { WADI TMAD GAMS ____ ____ ____ ____ ____ ____ ____ }
