...
set mymodId [$c create image $x $y -image asom_1$GIForient]
...
switch $GIForient {
n {set myportId [$c create image [expr $x + -26.0] [expr $y + 0.0] -image comm_e -anchor e]}
e {set myportId [$c create image [expr $x + 0.0] [expr $y + -26.0] -image comm_s -anchor s]}
s {set myportId [$c create image [expr $x + 26.0] [expr $y + 0.0] -image comm_w -anchor w]}
w {set myportId [$c create image [expr $x + 0.0] [expr $y + 26.0] -image comm_n -anchor n]}
}
