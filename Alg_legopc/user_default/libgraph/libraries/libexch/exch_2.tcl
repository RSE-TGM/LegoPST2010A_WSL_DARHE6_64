...
set mymodId [$c create image $x $y -image exch_2$GIForient]
...
switch $GIForient {
n {set myportId [$c create image [expr $x + 0.0] [expr $y + -62.0] -image hydr_n -anchor s]}
e {set myportId [$c create image [expr $x + 62.0] [expr $y + 0.0] -image hydr_e -anchor w]}
s {set myportId [$c create image [expr $x + 0.0] [expr $y + 62.0] -image hydr_s -anchor n]}
w {set myportId [$c create image [expr $x + -62.0] [expr $y + 0.0] -image hydr_w -anchor e]}
}
...
set port3.$mymodId { TPE1 TF11 GE11 ____ }
...
set port2.$mymodId { TPE2 TF21 GE21 ____ }
...
set port1.$mymodId { TPE3 TF31 GE31 ____ }
...
set port0.$mymodId { TPE4 TF41 GE41 ____ }

switch $GIForient {
n {set myportId [$c create image [expr $x + 0.0] [expr $y + 62.0] -image hydr_n -anchor n]}
e {set myportId [$c create image [expr $x + -62.0] [expr $y + 0.0] -image hydr_e -anchor e]}
s {set myportId [$c create image [expr $x + 0.0] [expr $y + -62.0] -image hydr_s -anchor s]}
w {set myportId [$c create image [expr $x + 62.0] [expr $y + 0.0] -image hydr_w -anchor w]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
