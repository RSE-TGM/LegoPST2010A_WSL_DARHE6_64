...
set mymodId [$c create image $x $y -image fumn_0$GIForient]
...
set port4.$mymodId { TM11 TF_1 GF_1 ____ }
...
set port2.$mymodId { TM13 TF_3 GF_3 ____ }
...
set port0.$mymodId { WIF_ ____ TUF_ ____ ____ %CO2 %PH2 %H2O }

switch $GIForient {
n {set myportId [$c create image [expr $x + 0.0] [expr $y + 38.0] -image flue_n -anchor n]}
e {set myportId [$c create image [expr $x + -38.0] [expr $y + 0.0] -image flue_e -anchor e]}
s {set myportId [$c create image [expr $x + 0.0] [expr $y + -38.0] -image flue_s -anchor s]}
w {set myportId [$c create image [expr $x + 38.0] [expr $y + 0.0] -image flue_w -anchor w]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
set port1.$mymodId { WIF_ ____ TIF_ ____ ____ %CO2 %PH2 %H2O }
