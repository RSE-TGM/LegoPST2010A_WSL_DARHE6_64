...
set mymodId [$c create image $x $y -image fumn_8$GIForient]
...
set port1.$mymodId { WIF_ ____ TIF_ ____ %CO2 %PH2 %H2O ____ }
...
switch $GIForient {
n {set myportId [$c create image [expr $x + -18.0] [expr $y + -40.0] -image term_w -anchor e]}
e {set myportId [$c create image [expr $x + 40.0] [expr $y + -18.0] -image term_n -anchor s]}
s {set myportId [$c create image [expr $x + 18.0] [expr $y + 40.0] -image term_e -anchor w]}
w {set myportId [$c create image [expr $x + -40.0] [expr $y + 18.0] -image term_s -anchor n]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
