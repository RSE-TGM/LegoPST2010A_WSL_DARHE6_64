...
set mymodId [$c create image $x $y -image fumn_3$GIForient]
...
switch $GIForient {
n {set myportId [$c create image [expr $x + -22.0] [expr $y + 40.0] -image term_w -anchor e]}
e {set myportId [$c create image [expr $x + -40.0] [expr $y + -22.0] -image term_n -anchor s]}
s {set myportId [$c create image [expr $x + 22.0] [expr $y + -40.0] -image term_e -anchor w]}
w {set myportId [$c create image [expr $x + 40.0] [expr $y + 22.0] -image term_s -anchor n]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
switch $GIForient {
n {set myportId [$c create image [expr $x + -22.0] [expr $y + 16.0] -image term_w -anchor e]}
e {set myportId [$c create image [expr $x + -16.0] [expr $y + -22.0] -image term_n -anchor s]}
s {set myportId [$c create image [expr $x + 22.0] [expr $y + -16.0] -image term_e -anchor w]}
w {set myportId [$c create image [expr $x + 16.0] [expr $y + 22.0] -image term_s -anchor n]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
