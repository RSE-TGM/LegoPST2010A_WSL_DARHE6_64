...
set mymodId [$c create image $x $y -image exch_5$GIForient]
...
switch $GIForient {
n {set myportId [$c create image [expr $x + 18.0] [expr $y + -8.0] -image term_w -anchor w]}
e {set myportId [$c create image [expr $x + 8.0] [expr $y + 18.0] -image term_n -anchor n]}
s {set myportId [$c create image [expr $x + -18.0] [expr $y + 8.0] -image term_e -anchor e]}
w {set myportId [$c create image [expr $x + -8.0] [expr $y + -18.0] -image term_s -anchor s]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
switch $GIForient {
n {set myportId [$c create image [expr $x + 18.0] [expr $y + -28.0] -image term_w -anchor w]}
e {set myportId [$c create image [expr $x + 28.0] [expr $y + 18.0] -image term_n -anchor n]}
s {set myportId [$c create image [expr $x + -18.0] [expr $y + 28.0] -image term_e -anchor e]}
w {set myportId [$c create image [expr $x + -28.0] [expr $y + -18.0] -image term_s -anchor s]}
}
$c addtag id$myportId withtag $myportId
$c addtag id$mymodId withtag $myportId
...
set port6.$mymodId { TPE5 TF51 GE51 ____ }
