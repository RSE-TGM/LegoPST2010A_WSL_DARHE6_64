...
proc\lg2.exe: proc\ltm.obj foraus.obj
	gfortran $(F_FLAGS) -c $(LG_LEGO)\lg2.obj $(LG_LEGO)\legolib.lib proc\ltm.obj foraus.obj $(LG_LIBUT)\moduli.lib $(LG_LIBUT)\foraus_b.lib $(LG_LEGO)\vapo.lib unix.lib -aliases:UNICODE.ALS
