...
#define pthread_attr_getprio           (pthd4_attr_getprio)
#define pthread_attr_setprio           (pthd4_attr_setprio)
#define pthread_attr_getsched          (pthd4_attr_getsched)
#define pthread_attr_setsched          (pthd4_attr_setsched)
#define pthread_attr_getinheritedsched (pthd4_attr_getinheritedsched)
#define pthread_attr_setinheritedsched (pthd4_attr_setinheritedsched)
#define pthread_attr_getguardsize_np   (pthd4_attr_getguardsize_np)
#define pthread_attr_setguardsize_np   (pthd4_attr_setguardsize_np)
...
#define pthread_mutexattr_create       (pthd4_mutexattr_create)
#define pthread_mutexattr_delete       (pthd4_mutexattr_delete)
#define pthread_mutexattr_getkind_np   (pthd4_mutexattr_getkind_np)
#define pthread_mutexattr_setkind_np   (pthd4_mutexattr_setkind_np)
...
#define pthread_cond_signal_int_np     (pthd4_cond_signal_int_np)
...
#define pthread_condattr_create        (pthd4_condattr_create)
#define pthread_condattr_delete        (pthd4_condattr_delete)

#undef pthread_lock_global_np         
#undef pthread_unlock_global_np       

#define pthread_lock_global_np         (pthd4_lock_global_np)
#define pthread_unlock_global_np       (pthd4_unlock_global_np)
...
#define pthread_equal                  (pthd4_equal)
...
#define pthread_setprio                (pthd4_setprio)
#define pthread_getprio                (pthd4_getprio)
#define pthread_setscheduler           (pthd4_setscheduler)
#define pthread_getscheduler           (pthd4_getscheduler)
...
#define pthread_get_unique_np          (pthd4_getunique_np)
#define pthread_getunique_np           (pthd4_getunique_np) 
#define pthread_signal_to_cancel_np    (pthd4_signal_to_cancel_np)
