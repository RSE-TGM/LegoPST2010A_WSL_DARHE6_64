 ...
 *
 * Loic- 2003.05.08 
 *  Fixed portability issue on Alpha (RPC__IP_ENDPOINT_SSCANF and 
 *  RPC__IP_ENDPOINT_SPRINTF used %lu for a 32 bits)
 *
 * Loic- 2004.12.10
...
#endif
{
    ...
    for (i = 0; i < n_elements; i++)
    {
        ...
        /* make sure we scan things right on 64-bit machines (alpha, x86_64) */
#if defined(__LP64)
