 ...
 * Loic- 05.05.03: 
 *
 *   fix error "`hex' undeclared (first use this function)"
 *   added reference to the std namespace.
 *
 * Loic- 13.05.03:
 *
 *   compliance to C++ standart: 
 *     changed <iostream.h> to <iostream>
 *     removed reference to <stream.h> that wasn't needed anymore.
 *
 **************************************************************************/
...
mk_c_initializer()
{
  ...
  cout << "  " << "0x" << hex << intl.time_low << "," 
       << "0x" << hex << intl.time_mid << "," 
