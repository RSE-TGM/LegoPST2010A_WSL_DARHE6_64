...
/* Accetta i parametri per l'OK_BUTTON  */
   ...
   {
      set_something_val (finestra,XmNokLabelString, (XtArgVal)  CREATE_CSTRING(chiama_funz[0].button_label));
...
/* Accetta i parametri per il CANCEL_BUTTON  */
   ...
   {
      set_something_val (finestra,XmNcancelLabelString, (XtArgVal)  CREATE_CSTRING(chiama_funz[1].button_label));
...
/* Accetta i parametri per l`HELP_BUTTON  */
   ...
   {
      set_something_val (finestra,XmNhelpLabelString, (XtArgVal)  CREATE_CSTRING(chiama_funz[2].button_label));
