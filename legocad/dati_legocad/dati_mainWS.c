/**********************************************************************
*
*       C Source:               dati_mainWS.c
*       Subsystem:              1
*       Description:
*       %created_by:    famgr %
*       %date_created:  Tue Apr 30 11:47:39 1996 %
*
**********************************************************************/
#ifndef lint
static char *_csrc = "@(#) %filespec: dati_mainWS.c,2 %  (%full_filespec: 1,csrc,dati_mainWS.c,2 %)";
#endif

/*******************************************************************************
	dati_mainWS.c

	Associated Resource file: dati_mainWS.rf
*******************************************************************************/
...
#ifndef DESIGN_TIME
/*
   modulo dati_mainWS.c
   tipo 
   release 2.15
   data 4/26/95
   reserved @(#)dati_mainWS.c	2.15
*/
/*
        Variabile per identificazione della versione
*/
static char SccsID[] = "@(#)dati_mainWS.c	2.15\t4/26/95";
/*
...
Widget	popup_dati_mainWS()
{
	...
	if ( ! _Uxinit )
	{
		UxLoadResources( "dati_mainWS.rf" );
		_Uxinit = 1;
	}
