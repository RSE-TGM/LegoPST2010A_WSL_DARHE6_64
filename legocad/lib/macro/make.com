...
$! release 2.8
$! data 96/04/05
$! reserver @(#)make.com	2.8
$!******************************************************************************
$
$ compile = "cc/optimize/define=MAIN/include_directory=(LEGOROOT_INCLUDE,LEGOCAD_INCLUDE,LEGORT_INCLUDE)"
...
$end:
$close infile
$ pu/nolog LEGOROOT_BIN:macro.exe
$ purge/nolog *.obj
$ exit
$finecomp:
...
$ linkexe/exe=LEGOROOT_BIN:macro macro.obj, popup.obj, draw.obj,-
		block_wdg.obj, files.obj,  macro_wdg.obj, symb_wdg.obj,-
