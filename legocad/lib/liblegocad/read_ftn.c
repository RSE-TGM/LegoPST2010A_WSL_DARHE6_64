...
*       Description:
*       %created_by:    lomgr %
*       %date_created:  Tue Jul 19 09:26:56 2005 %
*
**********************************************************************/
#ifndef lint
static char *_csrc = "@(#) %filespec: read_ftn.c-5 %  (%full_filespec: read_ftn.c-5:csrc:2 %)";
#endif
/*
        Variabile per identificazione della versione
*/
static char SccsID[] = "@(#)read_ftn.c	2.4\t2/13/95";
/*
