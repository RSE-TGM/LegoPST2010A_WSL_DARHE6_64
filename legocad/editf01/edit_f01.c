...
/*
   ...
   release 2.6
   data 3/20/95
   reserved @(#)edit_f01.c	2.6
*/
/*
        Variabile per identificazione della versione
*/
static char SccsID[] = "@(#)edit_f01.c	2.6\t3/20/95";
/*
	...
	char 	*argv[];
{
	...
	setlocale(LC_ALL, "");
  	...
  	UxTopLevel = XtAppInitialize(&UxAppContext, "edit_f01",
	 ...
	 *------------------------------------------------------*/
/* questo programma puo' ricevere in input dei parametri
   il nome del file
   e se editabile
   se specificati i parametri non creo lafile selection box
*/
         if(argc > 1)
         {
            char file[100];
            int editabile;
            strcpy(file,argv[1]);
            editabile = atoi(argv[2]);
            lancia_edit(file,editabile);
