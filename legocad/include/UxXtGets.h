...
*       Description:
*       %created_by:    lomgr %
*       %date_created:  Tue Nov  5 16:29:38 1996 %
*
**********************************************************************/
/*
...
/******************************************************************************/
/*				UxXtGets.h				      */
/* Modificata per applicativo legocad versione 2.0                            */
/******************************************************************************/
...
#include <Xm/Xm.h>
/*
 Prototiping di funzioni aggiuntive per LEGOCAD 2.0
*/
char *lcGetSelectedItems(Widget);
char *lcGetBackground(Widget);
char *lcGetForeground(Widget);
char *lcGetName(Widget);
char *lcGetParent(Widget);
...
#define UxGetName(wgt) \
        lcGetName(wgt)

#define UxGetParent(wgt) \
        lcGetParent(wgt) 
...
/* Aggiunta da Lorenzo Castiglioni */
#define UxGetXmStrRes( wgt, res_name ) \
	(XtVaGetValues( wgt, res_name, &UxXmStrValue, NULL ), \
	 (XmStringGetLtoR( UxXmStrValue, XmSTRING_DEFAULT_CHARSET, \
				&UxStrValue ) ? UxStrValue : NULL))
...
#define UxGetText( wgt ) \
	((char *)XmTextGetString(wgt))

#define UxGetTextField( wgt ) \
	((char *)XmTextFieldGetString(wgt))
/* fine modifica */
