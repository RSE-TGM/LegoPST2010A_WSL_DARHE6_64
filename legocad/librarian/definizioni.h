...
/*********************************************************/
typedef struct {
                   XmString cstring_modulo;
                   byte tipo_copia, flag_copia, tipo_lib;
                   char percorso[256];
                   long int offset;
                   Widget conferma_overwrite;
                } ModuleCheck;
...
void confirm_save();
void confirm_quit();
swidget create_lista_moduli();
swidget create_file_selection();
swidget create_modify_ftncode();
swidget create_nmod_shell();
swidget create_nmod_dialog_config();
swidget create_dialog_equation();
swidget create_dbox_userdata();
swidget create_dbox_userjac();
swidget create_dbox_userresid();
swidget create_dbox_usereq();
swidget create_dbox_new_file();
swidget create_doc_modulo();
