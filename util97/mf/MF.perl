...
#=======================================================================
#@(#)MF	Costruzione di file Y_*.scr da file *.MF	1998-01-29
#	
...
$Ver	= "MF - Versione: 1.5 1998-01-29";
...
#-----------------------------------------------------------------------
#	Costruisce un blocco per un comando analogico
#	[ Bottone with Lamp (quadrato) ]  [ Label ]
...
#-----------------------------------------------------------------------
#	Costruisce un blocco per un comando digitale
#	[ Bottone with Lamp (tondo) ]  [ Label ]
# Inoltre:
#	Testa il valore ed eventualmente effettua inversione.
#	Valore V. Secondaria (VsVax) = 0.0  : NOP immutato
#	Valore V. Secondaria (VsVax) = 1.0  : NOP trasformato in NOT

sub	bld_com_dig()
{

	$NOX	= 'NOP';				# default;
	$NOX	= 'NOT' if( $VsVa eq '1.0' );
#+	printf	"VsVa: {$VsVa} NOX: {$NOX}\n";
#.......................................................................
	printf	PFH "\nPLACE BottoneLamp  S%dbo\n", $j;	#! S... Debug Bottone
#+	printf	PFH "	varInputColore=%s NOP 1.0$codaIn\n", $ResVs;	# 1998-01-29
#+	printf	PFH "	varInputBlink=%s NOP 1.0$codaIn\n", $ResVs;	# 1998-01-29
	printf	PFH "	varInputColore=%s $NOX 1.0$codaIn\n", $ResVs;
	printf	PFH "	varOutput=%s $VsPt $VsVa$codaOu\n", $ResVs;
	printf	PFH "	tipoBt=1\n";			# Button with lamp
	printf	PFH "	actFg=%s\n", $red;
	printf	PFH "	normBg=%s\n", $grigio;
...
#-----------------------------------------------------------------------
#	Costruisce un blocco per una lettura analogica
#	[ Indicatore ]  [ Label ]

sub	bld_let_ana()
{
	printf	PFH "\nPLACE Indic         S%din\n", $j;	#! S... Indic
	$x	= $MARG_SX + 10;	# Indic/Var. Secondaria
	$x	= $MARG_SX +  0;	# Indic/Var. Secondaria
	printf	PFH "	x=%d\n	x0=%d\n", $x, $x;
	printf	PFH "	y=%d\n	y0=%d\n", $Ycrnt, $Ycrnt;
	printf	PFH "	varInputCambioColore1=%s NOP 1.0$codaIn\n", $ResVs;
	printf	PFH "ENDPLACE\n";
#.......................................................................
	...
	$x	= $MARG_SX + 110;	# Label/Var. Secondaria
	$Ycrnt	+= 10;	# Indic e' ????????? / messo qui abbassa il '%'
...
#-----------------------------------------------------------------------
#	Costruisce un blocco per una lettura digitale
#	[ Bottone with Lamp (quadrato) ]  [ Label ]
...
#+printf	"Classe dell'istanza (\$c): $c\n";
		...
		printf	PFH "INCLUDE	${dfDIR}Indic.dflt\n";
...
#.......................................................................
#	Scelta del tipo di blocco per la variabile secondaria
...
#-----------------------------------------------------------------------
#	Ritorna la coordinata x da assegnare alla stringa in argomento
#	perche' risulti centrata (in una window di larghezza W_MIN !).
#	Il calcolo ipotizza che la larghezza media di un carattere sia
#	di 9.2 pixel (dato ricavato sperimentalmente).
# NOTA:	Non e' stato possibile determinare la larghezza media in
#	pixel a partire dai  dati del font.
...
#	0;DEM;;Not in use;SPOM;IA;J1;;PERT_NOT;0.0;IN;;PERT_SCALINO;1.0;;;;;;;;
#	1;DEM3;;Not in use;SPOM;IA;J1;;PERT_NOT;0.0;;;;;;;;;;;;
#	2;DES;ACTUATOR;;SACT;IB;J3;Fault diagnosis off;PERT_NOT;0.0;;;;;;;;;;;;
#	3;DEV;SOLENOID DRIVE;;SPOM;IA;J1;Fault diagnosis off;PERT_NOT;0.0;;;;;;;;;;;;
...
#-----------------------------------------------------------------------
# Elabora un file contenente righe del tipo:
#	11;GT SIDE SWITCH;0ADA01GS009;0C0BTE-E0870BTE-TEST2;0C0BTE-E0870BTE-TEST2;;;
#	2;SOV U/STR N2 HTR;0REE10AA003;0I0CTE-Z2100CTE-TEST2;0I0CTE-Z2100CTE-TEST2;;;
#	13;0RHE61AA001 MAN VALVE;0RHE61AA001;1K0DTE-X0050DTE-TEST2;;;;
#	14;0RHE51AA001 MAN VALVE;0RHE51AA001;1K0ETE-X0060ETE-TEST2;;;;
...
#-----------------------------------------------------------------------
#	Aggiorna la variabile globale Wcrnt in base alla lunghezza della
#	stringa in argomento e i pixel per carattere (specifici del font)

sub	updateWcrnt()
{
# updateWcrnt( $x, $MfDe, $PPC_LA );
local( $xc, $txt, $ppc )	= @_;	# (superfluo) | stringa | pixel-per-carattere
local( $lll, $www );
